...
This section will go through a few different ways of how a Direct contract could be implemented. If you don't know what a Direct contract is, we recommend reading both [MangroveOffer](../explanations/mangrove-offer.md) and [Direct](../explanations/direct.md) before continuing.
