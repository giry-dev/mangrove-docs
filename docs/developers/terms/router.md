...
_Routers_ are a kind of building block for smart contracts provided by the [Strat Lib](../strat-lib/README.md). They can be used by [offer logics](/docs/developers/terms/offer-logic.md) to manage liquidity in a modular fashion. They _pull_ and _push_ liquidity.
