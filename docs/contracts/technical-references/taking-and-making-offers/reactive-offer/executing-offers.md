...
An account can post more than one offer. When it gets called through `makerExecute`, it will receive the %%id|offerId%% of the offer being executed as well as additional information.
