...
const FeatureList = [
  ...
  },
  {
    ...
    description: (
      <>
        Builders that want to develop their own market making strategies should read about the <a href="./strat-lib/">Mangrove Strat Library</a> with contract building blocks to help you write safe and efficient market making strats for Mangrove.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        Mangrovians who want to contribute to the Mangrove ecosystem by building and running keeper bots should visit the dedicated section on <a href="./keeper-bots/">Keeper bots</a>.
      </>
    ),
  },
];
