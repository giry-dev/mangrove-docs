...
* Approve the %%router|router%% of `Amplifier` to access the WETH of the tester contract, which was given as %%reserveId|reserveId%% when deploying the Amplifier (read more about [Approvals](./approvals.md)).
