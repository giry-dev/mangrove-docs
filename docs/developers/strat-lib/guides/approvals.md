...
Refer to [Contracts -> Technical Reference -> Overview](../../protocol/technical-references/overview.md) and the pages linked there for more details on trade execution on Mangrove.
